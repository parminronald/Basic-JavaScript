...
const nilai = "B";
switch (nilai){
    case "A": {console.log("Anda lulus dengan Sangat Baik");break;}
    case "B": {console.log("Anda lulus dengan baik");break;}
    case "C": {console.log("Anda lulus");break;}
    case "D": {console.log("Anda tidak lulus");break;}
    default: {console.log("Mungkin anda salah jurusan");}
}
